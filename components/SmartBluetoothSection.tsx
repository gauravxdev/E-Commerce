...
export default function SmartBluetoothSection() {
  const images = [
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 py-16">
      <h2 className="text-4xl md:text-5xl font-semibold text-gray-900 tracking-tight mb-12">
        Smart Bluetooth
      </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-6">
          ...
          <div className="flex sm:flex-col gap-4 justify-between sm:justify-start">
            {images.slice(1).map((img, i) => (
              ...
              >
                <Image src={img} alt={`Speaker angle ${i + 1}`} fill className="object-cover" />
              </button>
            ))}
          </div>
        ...
        <div className="flex flex-col space-y-6 lg:pl-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-3xl font-black text-gray-900">$189.00</span>
          </div>
          ...
          <button className="self-start bg-white rounded-full pl-6 pr-2 py-2 flex items-center shadow-xl border border-gray-100 hover:scale-105 transition-transform group mt-6">
            <span className="font-semibold text-sm mr-4 text-brand-dark">Buy Now</span>
